...
export function UnarchiveModal({ isOpen, onClose, onConfirm, isLoading = false }: UnarchiveModalProps) {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4">
            ...
            >
              <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-4">Restore Item</h3>
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">
                    Reason for restoring this item
                  </label>
                  <textarea
                    value={reason}
                    ...
                    required
                    disabled={isLoading}
                    placeholder="Enter the reason for restoring this item to active status..."
                  />
                </div>
